          ...
          @foreach ($tasks as $data)
              <div class="w-full bg-white br-10 box-shadow p-10 column g-10">
                <div class="row w-full space-between g-10">
                    ...
                    <div class="column m-right-auto g-5">
                       <div class="row g-5 align-center">
                        {{-- <img src="{{ asset('subcategories/'.$data->subcategory->icon ?? ''.'') }}" alt="" class="h-20 perfect-square no-shrink circle"> --}}
                         <strong class="font-1">{{ ucwords($data->title) ?? 'null' }}</strong>
                       </div>
                ...
                <div class="row align-center g-5">
                    ...
                    <strong class="font-1 c-green">&#8358;{{ number_format($data->category->reward ?? '0',2) }}</strong>
                </div>
                <div class="row align-center g-5">
                ...
                <div class="row align-center g-10 space-between">
                  {{-- delete btn --}}
                    ...
                    <button onclick='window.location.href=&quot;{{ url('admins/get/task/delete?id='.$data->id.'') }}&quot;' class='btn-red-3d w-full clip-5 g-5 br-5'>Yes! Delete Task</button>
                        ...
                        Delete</button>
                        {{-- proofs  btn --}}
                         <button onclick="window.location.href='{{ url('admins/tasks/submitted?task_id='.$data->id.'') }}'" style="background:black !important;border-bottom:3px solid rgb(61, 61, 61)" class="btn-primary-3d g-5 clip-5 br-5">
                        
                       VIew Submitted Proofs</button>
                       {{-- edit btn --}}
