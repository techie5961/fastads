...
@section('main')   
    <section class="column p-20  w-full flex-auto justify-center">
        <form action="{{ url('admins/post/login/process') }}" method="POST" onsubmit="PostRequest(event,this,call_back)" class="w-full max-w-500 p-20 align-center br-20 bg-transparent column g-5">
            <img src="{{ asset('favicon/logo.png?v=1.4') }}" class="w-quarter" alt="">
