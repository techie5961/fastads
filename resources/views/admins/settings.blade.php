...
<path d="M15.1696 2C16.3214 1.99999 17.2372 1.99999 17.9717 2.06982C18.7249 2.14143 19.3617 2.29154 19.9289 2.63915C20.5125 2.9968 21.0032 3.48748 21.3608 4.0711C21.7085 4.63836 21.8586 5.27514 21.9302 6.02829C22 6.76279 22 7.67871 22 8.83039V9.61699C22 10.4367 22 11.0886 21.9639 11.6173C21.927 12.1581 21.85 12.6226 21.6698 13.0575C21.2296 14.1202 20.3853 14.9646 19.3225 15.4048C19.2959 15.4158 19.2692 15.4265 19.2423 15.4367C19.114 15.4858 19.0042 15.5278 18.9077 15.5591C18.9217 15.0903 18.9217 14.5563 18.9217 13.9537V13.0614C18.9217 11.8598 18.9217 10.8532 18.8439 10.0349C18.7625 9.17817 18.5853 8.37421 18.1325 7.63536C17.6909 6.91475 17.0851 6.30889 16.3645 5.8673C15.6256 5.41453 14.8217 5.23733 13.9649 5.15588C13.1466 5.07807 12.14 5.07809 10.9384 5.07812H8.48326C7.66717 5.0781 6.94105 5.07809 6.30276 5.10245C6.3325 4.9994 6.37324 4.88128 6.42106 4.74264C6.5024 4.50682 6.60519 4.28381 6.73554 4.0711C7.09318 3.48748 7.58386 2.9968 8.16748 2.63915C8.73473 2.29154 9.37152 2.14143 10.1247 2.06982C10.8592 1.99999 11.775 1.99999 12.9268 2H15.1696Z" fill="var(--bg-secondary)"></path>
  ...
  <span class="desc bold c-bg-secondary ws-nowrap">Social Settings</span>
            ...
            <div class="column g-5 w-full">
                 <label for="">Whatsapp Advert Link</label>
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $social->whatsapp_ads ?? '' }}" type="url" placeholder="E.g https://t.me/your-whatsapp-ad-contact-link" name="whatsapp_ads"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
            </div>

               {{-- NEW INPUT --}}
            <div class="column g-5 w-full">
             <label for="">Telegram Advert Link</label>
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $social->telegram_ads ?? '' }}" type="url" placeholder="E.g https://t.me/your-telegram-ad-contact-link" name="telegram_ads"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
            </div>
            ...
            <div class="cont w-full border-1 border-color-silver br-10 clip-10 h-200 bg-dim">
                <textarea placeholder="Type Site notification here ...." name="notification" id="" cols="30" rows="10" class="inp input w-full h-full border-none placeholder-bold bold bg-dim br-10">{{ $social->notification ?? '' }}</textarea>
            </div>
            </div>
        ...
        <form action="{{ url('admins/post/general/settings/process') }}" method="POST" onsubmit="PostRequest(event,this)" class="w-full p-10 g-10 column bg-white box-shadow br-10">
            ...
            {{-- NEW INPUT --}}
           <div class="w-full display-none column g-5">
           ...
           <div class="w-full column g-5">
            ...
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $general->welcome_bonus ?? 0 }}" type="number" placeholder="E.g 7000" name="welcome_bonus"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
           </div>

              {{-- NEW INPUT --}}
           <div class="w-full column g-5">
              <label for="">First Level Referral Bonus</label>
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $general->referral->first ?? 0 }}" type="number" placeholder="E.g 4000" name="first_level_ref"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
           </div>
              {{-- NEW INPUT --}}
           <div class="w-full column g-5">
              <label for="">Second Level Referral Bonus</label>
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $general->referral->second ?? 0 }}" type="number" placeholder="E.g 2500" name="second_level_ref"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
           </div>
   ...
   {{-- NEW INPUT --}}
           <div class="w-full column g-5">
            ...
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $finance->deposit->account_number ?? '' }}" type="number" placeholder="E.g 5005016577" name="account_number"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
           </div>
            {{-- NEW INPUT --}}
           <div class="w-full column g-5">
            ...
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $finance->deposit->account_name ?? '' }}" type="text" placeholder="E.g John Doe" name="account_name"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
           </div>
            {{-- NEW INPUT --}}
           <div class="w-full column g-5">
            ...
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $finance->deposit->bank_name ?? '' }}" type="text" placeholder="E.g First Bank" name="bank_name"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
           </div>
           {{-- NEW INPUT --}}
           <div class="w-full column g-5">
            ...
            <div class="cont w-full h-50 br-10 border-1 border-color-silver bg-dim">
                <input value="{{ $finance->deposit->minimum_deposit ?? '' }}" type="number" placeholder="E.g 3000" name="minimum_deposit"  class="inp required input h-full w-full no-border bg-transparent br-10">
            </div>
           </div>
            {{-- NEW INPUT --}}
            <div class="column g-5 w-full">
           ...
           <div class="w-full p-10 column g-5 bg-secondary-light br-10 border-1 border-color-bg">
            <div class="row space-between g-10 align-center w-full">
                <strong class="desc c-bg" style="color:var(--bg-secondary)">Airtime Portal</strong>
           ...
           <div class="w-full p-10 column g-5 bg-secondary-light br-10 border-1 border-color-bg">
            <div class="row space-between g-10 align-center w-full">
                <strong class="desc c-bg" style="color:var(--bg-secondary)">Data Portal</strong>
           ...
           <div class="w-full p-10 column g-5 bg-secondary-light br-10 border-1 border-color-bg">
            <div class="row space-between g-10 align-center w-full">
                <strong class="desc c-bg" style="color:var(--bg-secondary)">Withdrawal Portal</strong>
           ...
           <div class="w-full p-10 column g-5 bg-secondary-light br-10 border-1 border-color-bg">
            <div class="row space-between g-10 align-center w-full">
                <strong class="desc" style="color:var(--bg-secondary)">Withdrawal Portal</strong>
