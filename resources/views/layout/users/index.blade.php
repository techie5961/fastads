...
<link rel="stylesheet" href="{{ asset('vitecss/css/app.css?v='.config('versions.vite_version').'') }}">
    ...
    <style>
      :root{
        --primary-brighter:rgb(253, 225, 154);
        --primary-bright:rgb(250, 203, 85);
        --gradient:linear-gradient(to right,goldenrod,gold);
        --gradient-text:white;
...
<body class="overflow-hidden">
 ...
 <header>
        ...
        <img  onclick="window.location.href='{{ url('/') }}'" src="{{ asset('favicon/logo.png?v=1.4') }}" alt="Logo" class="h-30 pc-pointer">
         <div onclick="
       if(document.querySelector('section.nav').classList.contains('active')){
        ...
        this.classList.add('active');
         ...
         <svg class="menu open" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="CurrentColor" height="20" width="20"><path d="M228,128a12,12,0,0,1-12,12H40a12,12,0,0,1,0-24H216A12,12,0,0,1,228,128ZM40,76H216a12,12,0,0,0,0-24H40a12,12,0,0,0,0,24ZM216,180H40a12,12,0,0,0,0,24H216a12,12,0,0,0,0-24Z"></path></svg>
...
<path d="M13 6.5C13 4.37868 13 3.31802 13.659 2.65901C14.318 2 15.3787 2 17.5 2C19.6213 2 20.682 2 21.341 2.65901C22 3.31802 22 4.37868 22 6.5C22 8.62132 22 9.68198 21.341 10.341C20.682 11 19.6213 11 17.5 11C15.3787 11 14.318 11 13.659 10.341C13 9.68198 13 8.62132 13 6.5Z" fill="CurrentColor"></path>
    ...
    <main class="pc-x-padding c-inherit">
...
<section onclick="HideSlideUp()" class="slideup">
  ...
  The future of a smart global economy
