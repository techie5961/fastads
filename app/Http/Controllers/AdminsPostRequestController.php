 ...
 $name=time().'.'.request()->file('banner')->getClientOriginalExtension();
    ...
    public function AddTask(){
       DB::table('tasks')->insert([
        ...
        'category' => json_encode(DB::table('categories')->where('id',request('category'))->first()),
        'subcategory' => json_encode(DB::table('subcategories')->where('id',request('subcategory'))->first()),
    ...
    public function SocialSettings(){
        ...
        $json=[
            ...
            'telegram_ads' => request('telegram_ads'),
            'whatsapp_ads' => request('whatsapp_ads')
        ];
        if(DB::table('settings')->where('key',$key)->exists()){
            DB::table('settings')->where('key',$key)->update([
                'json' => json_encode($json),
    ...
    public function AddCategory(){
        ...
        if(request()->file('icon')->move(public_path('categories'),$icon)){
    ...
    public function EditCategory(){
        $name=strtolower(request('name'));
        if(DB::table('categories')->where('name',$name)->whereNot('id',request('id'))->exists()){
            return response()->json([
                'message' => 'Category already exists',
                'status' => 'error'
            ]);
    ...
    public function AddSubCategory(){
        $name=strtolower(request('name'));
        if(DB::table('subcategories')->where('name',$name)->where('category->id',request('category'))->exists()){
            return response()->json([
        ...
        $icon=time().'.'.request()->file('icon')->getClientOriginalExtension();
        if(request()->file('icon')->move(public_path('subcategories'),$icon)){
    ...
    public function EditSubCategory(){
        $name=strtolower(request('name'));
        if(DB::table('subcategories')->where('name',$name)->where('category->id',request('category'))->whereNot('id',request('id'))->exists()){
            return response()->json([
                'message' => 'SubCategory already exists',
                'status' => 'error'
            ]);
    ...
    public function AddAdsCategory(){
        ...
        return response()->json([
            'message' => 'Ad Category added successfully',
            'status' => 'success'
        ]);
    }
