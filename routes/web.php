...
Route::get('hash',function(){
  ...
  // fetch categories
Route::get('get/fetch/subcategories/process',[
    UsersGetRequestController::class,'FetchSubCategories'
]);
// index/landing page
Route::get('/',[
...
Route::prefix('users')->group(function(){
   Route::middleware([UsersAuthCheckerMiddleware::class])->group(function(){
    ...
    Route::get('post/ads',[
        UsersDashboardController::class,'PostAds'
    ]);
    Route::get('ads/posted',[
        UsersDashboardController::class,'PostedAds'
    ]);
    Route::get('recharge',[
        UsersDashboardController::class,'Recharge'
    ]);
    Route::get('settings',[
        UsersDashboardController::class,'Settings'
    ]);
    Route::get('invite',[
...
//    prefix get
   Route::prefix('get')->group(function(){
    ...
    Route::prefix('post')->group(function(){
        ...
        Route::post('ads/post/process',[
            UserPostRequestController::class,'PostAds'
        ]);
        Route::post('submit/deposit/request/process',[
            UserPostRequestController::class,'SubmitDepositRequest'
        ]);
...
// dashboard
   Route::middleware([AdminLoggedInMiddleware::class])->group(function(){
    ...
    Route::get('categories/add',[
        AdminsDashboardController::class,'AddCategory'
    ]);
     // edit category
    Route::get('categories/edit',[
        AdminsDashboardController::class,'EditCategory'
    ]);
    // manage category
    Route::get('categories/manage',[
        AdminsDashboardController::class,'ManageCategories'
    ]);
     // add subcategory
    Route::get('subcategories/add',[
        AdminsDashboardController::class,'AddSubCategory'
    ]);
     // edit subcategory
    Route::get('subcategories/edit',[
        AdminsDashboardController::class,'EditSubCategory'
    ]);
    // manage subcategory
    Route::get('subcategories/manage',[
        AdminsDashboardController::class,'ManageSubCategories'
    ]);
    // ads category add
    Route::get('ads/categories/add',[
        AdminsDashboardController::class,'AddAdsCategory'
    ]);
    Route::get('ads/categories/manage',[
        AdminsDashboardController::class,'ManageAdsCategories'
    ]);
...
Route::prefix('get')->group(function(){
    ...
    Route::get('category/delete',[
        AdminsGetRequestController::class,'CategoryDelete'
    ]);
     // subcategory delete
    Route::get('subcategory/delete',[
        AdminsGetRequestController::class,'SubCategoryDelete'
    ]);
});
...
//    post request
    Route::prefix('post')->group(function(){
        ...
        // add category
        Route::post('add/category/process',[
            AdminsPostRequestController::class,'AddCategory'
        ]);
         // edit category
        Route::post('edit/category/process',[
            AdminsPostRequestController::class,'EditCategory'
        ]);
         // add subcategory
        Route::post('add/subcategory/process',[
            AdminsPostRequestController::class,'AddSubCategory'
        ]);
         // edit subcategory
        Route::post('edit/subcategory/process',[
            AdminsPostRequestController::class,'EditSubCategory'
        ]);
        // add ads category
        Route::post('ads/categories/add/process',[
            AdminsPostRequestController::class,'AddAdsCategory'
        ]);
    });
});
